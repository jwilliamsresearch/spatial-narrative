...
- [Event](./core/event.md)
- [Narrative](./core/narrative.md)
- [Bounds](./core/bounds.md)
- [Sources](./core/sources.md)

# I/O Formats

- [Overview](./io/overview.md)
- [JSON Format](./io/json.md)
- [GeoJSON Format](./io/geojson.md)
- [CSV Format](./io/csv.md)
- [Custom Formats](./io/custom.md)

# Indexing

- [Overview](./index/overview.md)
- [Spatial Index (R-tree)](./index/spatial.md)
- [Temporal Index (B-tree)](./index/temporal.md)
- [Spatiotemporal Index](./index/spatiotemporal.md)
- [Heatmaps](./index/heatmaps.md)

# Graph Analysis

- [Overview](./graph/overview.md)
- [Building Graphs](./graph/building.md)
- [Connection Strategies](./graph/connections.md)
...
- [Filtering Events](./cookbook/filtering.md)
